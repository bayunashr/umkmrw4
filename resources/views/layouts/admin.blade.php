...
<head>
    ...
    <title>@yield('title', 'Admin Panel - Banjarsugihan UMKM Digital Map')</title>
    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <!-- Katalog UMKM -->
                <li class="menu-header mt-5">
                    <span class="menu-header-text" data-i18n="Katalog UMKM">Katalog UMKM</span>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="app-email.html" class="menu-link">
                        ...
                        <div data-i18n="Data Foto">Data Foto</div>
                    </a>
                </li>
